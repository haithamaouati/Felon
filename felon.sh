...
echo -e "${faint}  Scrape TikTok account details by username.${normal}\n"
echo -e "           Author: Haitham Aouati"
echo -e "       GitHub: ${underlined}github.com/haithamaouati${normal}\n"

# Prompt for username
echo -e "${faint}Enter the TikTok username ${italics}(without @)${normal}"
read -p "Username: " username
echo -e "\nScraping TikTok account details for ${yellow}@$username${normal}\n"
